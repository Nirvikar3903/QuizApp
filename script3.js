...
const defaultQuestions = [
    {
        ...
        options: [{id: 1, value: "The main heading of the page"}, {id: 2, value: "The title of the document that appears in the browser tab"},{id: 3, value: "The footer of the document"}, {id: 4, value: "The subtitle of the page"}],
        answer: 2,
    },
    {
        id:2,
